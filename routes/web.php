...
use App\Http\Controllers\{
    AdminAuthController, AdminDashboardController, AddController, UsersController,
    PartnersController, WritersController, BooksController, AudiobooksController,
    PartnerBooksController, OrdersController, SubscriptionController, EventsController,
    QuestionsController, CommunityController, ReportsController
};

// 1) Home → admin auth
Route::redirect('/', '/admin/auth');

Route::prefix('admin')->group(function () {
    Route::get('/', fn () => redirect()->route('admin.auth'));

    // Public auth
    Route::get('/auth', [AdminAuthController::class, 'showAuthPage'])->name('admin.auth');
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::post('/books/delete',   [BooksController::class, 'destroy'])->name('admin.books.delete');

        // Audiobooks
        Route::get('/audiobooks',         [AudiobooksController::class, 'index'])->name('admin.audiobooks');
        Route::post('/audiobooks/update', [AudiobooksController::class, 'update'])->name('admin.audiobooks.update');
        Route::post('/audiobooks/delete', [AudiobooksController::class, 'destroy'])->name('admin.audiobooks.delete');

        // Partner Books
        Route::get('/partnerbooks', [PartnerBooksController::class, 'index'])->name('admin.partnerbooks');
        Route::post('/partnerbooks/approve', [PartnerBooksController::class, 'approve'])->name('admin.partnerbooks.approve');
        Route::post('/partnerbooks/delete', [PartnerBooksController::class, 'destroy'])->name('admin.partnerbooks.delete');
        Route::post('/partnerbooks/return-date', [PartnerBooksController::class, 'setReturnDate'])->name('admin.partnerbooks.returnDate');

        // Orders
        Route::get('/orders', [OrdersController::class, 'index'])->name('admin.orders');
        Route::post('/orders/status', [OrdersController::class, 'updateStatus'])->name('admin.orders.updateStatus');
        Route::post('/orders/delete', [OrdersController::class, 'destroy'])->name('admin.orders.delete');
        Route::get('/orders/edit/{id}', [OrdersController::class, 'edit'])->name('admin.orders.edit');
        Route::post('/orders/edit/{id}', [OrdersController::class, 'update'])->name('admin.orders.update');
        Route::get('/orders/{order}/items', [OrdersController::class, 'items'])->name('admin.orders.items');
        ...
        // Questions
        Route::get('/question', [QuestionsController::class, 'index'])->name('admin.question');
        Route::post('/question/answer', [QuestionsController::class, 'storeAnswer'])->name('admin.question.answer.store');
        Route::put('/question/answer/{answer_id}', [QuestionsController::class, 'updateAnswer'])->name('admin.question.answer.update');
        Route::delete('/question/answer/{answer_id}', [QuestionsController::class, 'destroyAnswer'])->name('admin.question.answer.destroy');

        // Community (fixed paths)
        Route::get('/community', [CommunityController::class, 'index'])->name('admin.community');
        Route::delete('/community', [CommunityController::class, 'destroy'])->name('admin.community.destroy');
